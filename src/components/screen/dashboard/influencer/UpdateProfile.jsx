...
export default function UpdateProfile({ email, profileData, isFromRegister }) {
  ...
  const [igAccount, setIgAccount] = useState(profileData?.igAccount ?? '')
  const [igFollowers, setIgFollowers] = useState(profileData?.igFollowers ?? '')
  const [tiktokAccount, setTiktokAccount] = useState(profileData?.tiktokAccount ?? '')
  const [tiktokFollowers, setTiktokFollowers] = useState(profileData?.tiktokFollowers ?? '')
  ...
  const [feeIgPost, setFeeIgPost] = useState(profileData?.feeIgPost ?? '')
  const [feeIgStory, setFeeIgStory] = useState(profileData?.feeIgPost ?? '')
  const [feeIgReels, setFeeIgReels] = useState(profileData?.feeIgPost ?? '')
  const [feeTiktok, setFeeTiktok] = useState(profileData?.feeTiktok ?? '')
  ...
  const handleIgAccountChange = (event) => {
    setIgAccount(event.target.value)
  }

  const handleIgFollowersChange = (event) => {
    setIgFollowers(event.target.value)
  }

  const handleTiktokAccountChange = (event) => {
    setTiktokAccount(event.target.value)
  }

  const handleTiktokFollowersChange = (event) => {
    setTiktokFollowers(event.target.value)
  }

  const handleFeeIgPostChange = (event) => {
    setFeeIgPost(event.target.value)
  }

  const handleFeeIgStoryChange = (event) => {
    setFeeIgStory(event.target.value)
  }

  const handleFeeIgReelsChange = (event) => {
    setFeeIgReels(event.target.value)
  }

  const handleFeeTiktokChange = (event) => {
    setFeeTiktok(event.target.value)
  }
  ...
  const handleSubmit = (event) => {
    ...
    if (
      ...
      formData.append('igFollowers', igFollowers)
      formData.append('tiktokAccount', tiktokAccount)
      formData.append('tiktokFollowers', tiktokFollowers)
      formData.append('feeIgPost', feeIgPost)
      formData.append('feeIgStory', feeIgStory)
      formData.append('feeIgReels', feeIgReels)
      formData.append('feeTiktok', feeTiktok)
    ...
    <>
      {isUpdateProfile ? (
            ...
            <form
              ...
              <div className="grid grid-cols-1 gap-x-6 gap-y-8 text-left sm:grid-cols-6">
                ...
                {/* <div className="sm:col-span-3">
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      required
                      className="block w-full rounded-md border-0 py-1 px-2 text-stone-900 shadow-sm ring-1 ring-inset ring-stone-300 placeholder:text-stone-400 focus:ring-2 focus:ring-inset focus:ring-rose-600 sm:text-sm sm:leading-6"
                    />
                  </div>
                  <p className="mt-1 text-sm text-red-600">
                ...
                <div className="sm:col-span-3">
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      id="igAccount"
                      value={igAccount}
                      onChange={handleIgAccountChange}
                      required
                      className="block w-full rounded-md border-0 px-2 py-1 text-stone-900 shadow-sm ring-1 ring-inset ring-stone-300 placeholder:text-stone-400 focus:ring-2 focus:ring-inset focus:ring-rose-600 sm:text-sm sm:leading-6"
                    />
                  </div>
                  <p className="mt-1 text-sm text-red-600">
                    {igAccount === '' && isSubmit ? errorEmptyMessage : ''}
                  </p>
                </div>
                ...
                <div className="sm:col-span-3">
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      id="igFollowers"
                      value={igFollowers}
                      onChange={handleIgFollowersChange}
                      required
                      className="block w-full rounded-md border-0 px-2 py-1 text-stone-900 shadow-sm ring-1 ring-inset ring-stone-300 placeholder:text-stone-400 focus:ring-2 focus:ring-inset focus:ring-rose-600 sm:text-sm sm:leading-6"
                    />
                  </div>
                  <p className="mt-1 text-sm text-red-600">
                    {igFollowers === '' && isSubmit ? errorEmptyMessage : ''}
                  </p>
                </div>
                ...
                <div className="sm:col-span-3">
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      id="tiktokAccount"
                      value={tiktokAccount}
                      onChange={handleTiktokAccountChange}
                      required
                      className="block w-full rounded-md border-0 px-2 py-1 text-stone-900 shadow-sm ring-1 ring-inset ring-stone-300 placeholder:text-stone-400 focus:ring-2 focus:ring-inset focus:ring-rose-600 sm:text-sm sm:leading-6"
                    />
                  </div>
                  <p className="mt-1 text-sm text-red-600">
                    {tiktokAccount === '' && isSubmit ? errorEmptyMessage : ''}
                  </p>
                </div>
                ...
                <div className="sm:col-span-3">
                  ...
                  <p className="mt-1 text-sm text-red-600">
                    {tiktokFollowers === '' && isSubmit ? errorEmptyMessage : ''}
                  </p>
                </div>
                ...
                <div className="sm:col-span-3">
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      id="feeIgPost"
                      value={feeIgPost}
                      onChange={handleFeeIgPostChange}
                      required
                      className="block w-full rounded-md border-0 px-2 py-1 text-stone-900 shadow-sm ring-1 ring-inset ring-stone-300 placeholder:text-stone-400 focus:ring-2 focus:ring-inset focus:ring-rose-600 sm:text-sm sm:leading-6"
                    />
                  </div>
                  <p className="mt-1 text-sm text-red-600">
                    {feeIgPost === '' && isSubmit ? errorEmptyMessage : ''}
                  </p>
                </div>
                ...
                <div className="sm:col-span-3">
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      id="feeIgStory"
                      value={feeIgStory}
                      onChange={handleFeeIgStoryChange}
                      required
                      className="block w-full rounded-md border-0 px-2 py-1 text-stone-900 shadow-sm ring-1 ring-inset ring-stone-300 placeholder:text-stone-400 focus:ring-2 focus:ring-inset focus:ring-rose-600 sm:text-sm sm:leading-6"
                    />
                  </div>
                  <p className="mt-1 text-sm text-red-600">
                    {feeIgStory === '' && isSubmit ? errorEmptyMessage : ''}
                  </p>
                </div>
                ...
                <div className="sm:col-span-3">
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      id="feeIgReels"
                      value={feeIgReels}
                      onChange={handleFeeIgReelsChange}
                      required
                      className="block w-full rounded-md border-0 px-2 py-1 text-stone-900 shadow-sm ring-1 ring-inset ring-stone-300 placeholder:text-stone-400 focus:ring-2 focus:ring-inset focus:ring-rose-600 sm:text-sm sm:leading-6"
                    />
                  </div>
                  <p className="mt-1 text-sm text-red-600">
                    {feeIgReels === '' && isSubmit ? errorEmptyMessage : ''}
                  </p>
                </div>
                ...
                <div className="sm:col-span-3">
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      id="feeTiktok"
                      value={feeTiktok}
                      onChange={handleFeeTiktokChange}
                      required
                      className="block w-full rounded-md border-0 px-2 py-1 text-stone-900 shadow-sm ring-1 ring-inset ring-stone-300 placeholder:text-stone-400 focus:ring-2 focus:ring-inset focus:ring-rose-600 sm:text-sm sm:leading-6"
                    />
                  </div>
                  <p className="mt-1 text-sm text-red-600">
                    {feeTiktok === '' && isSubmit ? errorEmptyMessage : ''}
                  </p>
                </div>
        ...
        <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-6 lg:px-8">
          ...
          <div className="m-auto mt-12 max-w-xl border border-stone-900 bg-white p-4 text-center shadow-sm">
