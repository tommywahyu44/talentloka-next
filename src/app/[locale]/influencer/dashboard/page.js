...
import UpdateProfile from '@/components/screen/dashboard/influencer/UpdateProfile'
...
function sendEmailNotification() {
  const actionCodeSettings = {
    url: 'https://hireplace.com/influencer/dashboard',
  }
...
export default function Dashboard() {
  ...
  const fetchUserData = async (email) => {
    ...
    const spgRef = ref(db, `promotor_influencer_unconfirmed/${emailDoc}`)
        ...
        <div className="bg-rose-950 pb-32">
          ...
          <header className="py-10">
            <div className="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8">
              <h1 className="text-3xl font-bold tracking-tight text-white">Dashboard Influencer</h1>
            </div>
          </header>
        </div>
